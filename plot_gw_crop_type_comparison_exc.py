...
def gw_crop_type_comparison_plot(irrigation_district_list):
    ...
    for num, irrigation_district in enumerate(irrigation_district_list):
        ...
        ax.scatter(district_matrix.perennial_annual_ratio[num], district_matrix.gw_surface_percent[num], color = 'red', s = point_size[num], alpha = 0.7 )
        ax.scatter(district_matrix.perennial_annual_ratio[num], district_matrix.gw_surface_percent_wet[num], color = 'green' , s = point_size[num], alpha = 0.7 )
    ...
    plt.ylabel('Surface water use within the irrigation district \n as percent of total agricultural water ', fontsize = 14)
    # pdb.set_trace()
    ...
    plt.title('District Comparison of Perennial Crop Acreage and Surface Water Reliance')
    plt.show()
    pdb.set_trace()
